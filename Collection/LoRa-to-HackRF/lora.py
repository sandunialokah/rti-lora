...
class lora(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lora")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/media/sanduni-aaloka/D040-797F/Ground 4-9-2025/rightThird3.cfile', False)
